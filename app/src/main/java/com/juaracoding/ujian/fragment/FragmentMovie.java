package com.juaracoding.ujian.fragment;
...
import com.juaracoding.ujian.activities.DetaiMoviesActivity;
import com.juaracoding.ujian.adapter.MovieAdapter;
import com.juaracoding.ujian.adapter.MovieHorizontalAdapter;
...
public class FragmentMovie extends Fragment implements MovieHorizontalAdapter.onSelectData, MovieAdapter.onSelectData {
    ...
    public void onSelected(ModelMovie modelMovie) {
        Intent intent = new Intent(getActivity(), DetaiMoviesActivity.class);
